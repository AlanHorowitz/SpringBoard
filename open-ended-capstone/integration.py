...
RetailDW.etlutils.create_table(
    source_connection, RetailDW.product.PRODUCT_CREATE_SQL_PG
)
...
RetailDW.etlutils.create_table(
    source_connection, RetailDW.store_sales.STORE_SALES_CREATE_SQL_PG
)
inserted, updated = RetailDW.etlutils.load_source_table(
