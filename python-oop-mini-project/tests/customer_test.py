...
def test_equality():
    ...
    a.set_info(
        first_name="Bob", last_name="Jones", social_security_number="123", pin="555"
    )
    b.set_info(
        first_name="Bob", last_name="Jones", social_security_number="456", pin="555"
    )
    c.set_info(
        first_name="Bob", last_name="Jones", social_security_number="123", pin="666"
    )
    d.set_info(
        first_name="Bob", last_name="Smith", social_security_number="123", pin="666"
    )
    assert a != b
    assert a == c
    assert b != c
